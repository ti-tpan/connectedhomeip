...
//#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_ID 0x8007
//#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_ID 0x0100
//#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_ID 0xFEFF

#ifdef CHIP_DEVICE_CONFIG_DEVICE_TYPE
#undef CHIP_DEVICE_CONFIG_DEVICE_TYPE
#endif

//#define CHIP_DEVICE_CONFIG_DEVICE_TYPE 0x0100 // On/Off Light
//#define CHIP_DEVICE_CONFIG_DEVICE_TYPE 0x0101 // Dimmable Light
//#define CHIP_DEVICE_CONFIG_DEVICE_TYPE 0x010A // On/Off Plug
#define CHIP_DEVICE_CONFIG_DEVICE_TYPE 0x010B // Dimmable Plug
...
// toby: increase this so light can let switch bind to it (default is 8)
#define CHIP_SYSTEM_CONFIG_PACKETBUFFER_POOL_SIZE 0 // this indicates default to CHIP_CONFIG_MAX_EXCHANGE_CONTEXTS
#define CHIP_CONFIG_MAX_EXCHANGE_CONTEXTS 20 // default is 8

#define CHIP_DEVICE_PLAT_USE_LOGS    0
