...
int AppTask::Init()
{
    ...
    // Initialize LightSwitch module
    PLAT_LOG("Initialize LightSwitch");
    LightSwitchManager::GetInstance().Init(kLightSwitchEndpointId);
...
void AppTask::DispatchEvent(AppEvent * aEvent)
{
    ...
    case AppEvent::kEventType_ButtonLeft:
        ...
        {
	    // Turn on remote light
	    PLAT_LOG("BTN-1: Light Switch Event: ON");
            LightSwitchManager::GetInstance().InitiateActionSwitch(LightSwitchManager::Action::ON_ACTION);
	}
    ...
    case AppEvent::kEventType_ButtonRight:
        if (AppEvent::kAppEventButtonType_Clicked == aEvent->ButtonEvent.Type)
        {
            // Turn off remote light
	    PLAT_LOG("BTN-2: Light Switch Event: OFF");
	    LightSwitchManager::GetInstance().InitiateActionSwitch(LightSwitchManager::Action::OFF_ACTION);
        }
        else if (AppEvent::kAppEventButtonType_LongClicked == aEvent->ButtonEvent.Type)
        {
